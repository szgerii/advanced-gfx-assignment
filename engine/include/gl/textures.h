...
public:
    ...
    static void unbind(GLuint texture_unit) { glBindTextureUnit(texture_unit, 0); }
...
// enum value matches the corresponding mipmap layer level
// you can either use axis or general direction based naming (or both)
